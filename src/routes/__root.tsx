...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "THE CUT — Win $50K. Launch your fashion career." },
      { name: "description", content: "THE CUT is the global fashion competition discovering, funding, and accelerating emerging designers. 3 rounds. 10 finalists. 1 winner." },
      { name: "author", content: "THE CUT" },
      { property: "og:title", content: "THE CUT — Launch your fashion career." },
      { property: "og:description", content: "Win $50K, a CFDA mentorship, and a runway in NYC." },
